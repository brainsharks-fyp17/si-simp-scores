...
normal_file_path = '../datasets/normal.aligned'
simple_file_path = '../datasets/simple.aligned'
...
def read_pair():
    global i
    cl = complex_file.readline().split("\t")[2].strip()
    sl = simple_file.readline().split("\t")[2].strip()
    i = i + 1
    return i, cl, sl
