...
normal_file_path = '../datasets/ss.original'
simple_file_path = '../datasets/ss.ls-simplified'
output_file_path = '../output/output_simpa.txt'
i = 0
...
def read_pair():
    global i
    cl = complex_file.readline().strip()
    sl = simple_file.readline().strip()
    i = i + 1
    return i, cl, sl
