...
model_fasttext_trigram = fasttext.train_supervised(
    '/content/drive/My Drive/Complete_dataset/models1/fastText_train_dataset.txt', ws=2, minn=2, maxn=6, lr=0.5,
    epoch=50, loss='hs', wordNgrams=3)
